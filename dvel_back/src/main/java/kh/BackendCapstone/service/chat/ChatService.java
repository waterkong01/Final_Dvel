...
/*    private void init() {
    ...
    public ChatRoomResDto createChatRoom(Long senderId, Long receiverId) {
        ...
        Optional<ChatRoom> existingRoom = chatRoomRepository
                .findBySenderMemberIdAndReceiverMemberId(senderId, receiverId)
                .or(() -> chatRoomRepository.findBySenderMemberIdAndReceiverMemberId(receiverId, senderId));
...
/*    // 참여 이후 채팅 내역
    ...
    // 채팅 메세지 DB 저장
    public void saveMsg(String roomId, Long memberId, String nickName, String msg, String profile) {
        ChatRoom chatRoom = chatRoomRepository.findById(roomId)
