                ...
                {chatList?.map((chat, index) => {
                    ...
                    return (
                        <React.Fragment key={index}>
                            ...
                            <MessageBox isSender={chat.sendMember === sendMember}>
                                <Sender isSender={chat.sendMember === sendMember}>
                                    {chat.sendMember}
                                </Sender>
                                <MsgTime isSender={chat.sendMember === sendMember}>
                                    <Message isSender={chat.sendMember === sendMember}>
                                        {chat.msg}
                                    </Message>
                                    <SentTime>
